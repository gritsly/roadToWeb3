...
contract SaturnBears is ERC721, ERC721Enumerable, ERC721URIStorage {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    

    uint256 MAX_SUPPLY = 5000; // constants - capital letters
    uint256 WALLET_LIMIT = 3;

    mapping(address => Counters.Counter) private _walletMintCount;
    
    constructor() ERC721("SaturnBears", "STB") {}
